...
var (
	GooseDBVersionAllColumns            = gooseDBVersionAllColumns
	GooseDBVersionColumnsWithoutDefault = gooseDBVersionColumnsWithoutDefault
	GooseDBVersionColumnsWithDefault    = gooseDBVersionColumnsWithDefault
	GooseDBVersionPrimaryKeyColumns     = gooseDBVersionPrimaryKeyColumns
	GooseDBVersionGeneratedColumns      = gooseDBVersionGeneratedColumns
)

// GetID get ID from model object
func (o *GooseDBVersion) GetID() int {
	return o.ID
}

// GetIDs extract IDs from model objects
func (s GooseDBVersionSlice) GetIDs() []int {
...
func (s GooseDBVersionSlice) GetIntfIDs() []interface{} {
...
func (s GooseDBVersionSlice) ToIDMap() map[int]*GooseDBVersion {
	result := make(map[int]*GooseDBVersion, len(s))
	for _, o := range s {
		result[o.ID] = o
	}
	return result
...
func (s GooseDBVersionSlice) ToUniqueItems() GooseDBVersionSlice {
	result := make(GooseDBVersionSlice, 0, len(s))
...
func (s GooseDBVersionSlice) FindItemByID(id int) *GooseDBVersion {
	for _, o := range s {
		if o.ID == id {
			return o
		}
...
func (s GooseDBVersionSlice) FindMissingItemIDs(expectedIDs []int) []int {
	if len(s) == 0 {
		return expectedIDs
	}
	result := []int{}
...
func (o GooseDBVersionSlice) InsertAll(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to insert all from gooseDBVersion slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by insertall for goose_db_version")
	}

	if len(gooseDBVersionAfterInsertHooks) != 0 {
		for _, obj := range o {
...
func (o GooseDBVersionSlice) InsertIgnoreAll(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	return o.UpsertAll(ctx, exec, false, gooseDBVersionPrimaryKeyColumns, boil.None(), columns)
}
...
// IMPORTANT: this will calculate the widest columns from all items in the slice, be careful if you want to use default column values
// IMPORTANT: if the table has `id` column of auto-increment type, this may not work as expected
func (o GooseDBVersionSlice) UpsertAll(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	if updateOnConflict && len(update) == 0 {
		return 0, errors.New("models: unable to upsert goose_db_version, could not build update column list")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to upsert for goose_db_version")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by upsert for goose_db_version")
	}

	if len(gooseDBVersionAfterUpsertHooks) != 0 {
		for _, obj := range o {
...
// DeleteAllByPage delete all GooseDBVersion records from the slice.
// This function deletes data by pages to avoid exceeding Postgres limitation (max parameters: 65535)
func (s GooseDBVersionSlice) DeleteAllByPage(ctx context.Context, exec boil.ContextExecutor, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
...
// UpdateAllByPage update all GooseDBVersion records from the slice.
// This function updates data by pages to avoid exceeding Postgres limitation (max parameters: 65535)
func (s GooseDBVersionSlice) UpdateAllByPage(ctx context.Context, exec boil.ContextExecutor, cols M, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
...
// InsertAllByPage insert all GooseDBVersion records from the slice.
// This function inserts data by pages to avoid exceeding Postgres limitation (max parameters: 65535)
func (s GooseDBVersionSlice) InsertAllByPage(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
	...
	// max number of parameters = 65535
	chunkSize := MaxPageSize / reflect.ValueOf(&GooseDBVersionColumns).Elem().NumField()
...
// InsertIgnoreAllByPage insert all GooseDBVersion records from the slice.
// This function inserts data by pages to avoid exceeding Postgres limitation (max parameters: 65535)
func (s GooseDBVersionSlice) InsertIgnoreAllByPage(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
...
// UpsertAllByPage upsert all GooseDBVersion records from the slice.
// This function upserts data by pages to avoid exceeding Postgres limitation (max parameters: 65535)
func (s GooseDBVersionSlice) UpsertAllByPage(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, limits ...int) (int64, error) {
	length := len(s)
	if length == 0 {
		return 0, nil
	}
